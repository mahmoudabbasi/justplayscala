...
case controllers_Restricted_list3_route(params) => {
   call(params.fromQuery[Int]("p", Some(1)), params.fromQuery[Int]("s", Some(2)), params.fromQuery[String]("f", Some("" )), params.fromQuery[String]("u", Some("" )), params.fromQuery[String]("e", Some("" ))) { (p, s, f, u, e) =>
